    ...
    implements GuidesInterface
{
    ...
    public componentDidMount() {
        this.gesto = new Gesto(this.manager.getElement(), {
            ...
            .on("dragStart", (e) => {
                ...
                let isLockRemove =
                    lockGuides && lockGuides.indexOf("remove") > -1;
                let isLockChange =
                    lockGuides && lockGuides.indexOf("change") > -1;
    ...
    private onDragEnd = (e: OnDragEnd) => {
        ...
        const { onChangeGuides, zoom, displayDragPos, digit, lockGuides } =
            this.props;
    ...
    private movePos(e: any) {
        ...
        const props = this.props;
        const { type, zoom, snaps, snapThreshold, displayDragPos, digit } =
            props;
